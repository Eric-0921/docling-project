...
/home/tseng/anaconda3/envs/doclingprj1/bin/python scripts/convert_pdf.py --input "$INPUT_PDF" --output "$OUTPUT_DIR"
...
if [ -f "$JSON_OUTPUT" ]; then
    ...
    /home/tseng/anaconda3/envs/doclingprj1/bin/python scripts/postprocess_kb.py "$JSON_OUTPUT"

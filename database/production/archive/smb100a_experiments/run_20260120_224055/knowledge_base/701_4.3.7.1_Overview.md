...
Activating a sweep mode immediately disables NRP Level Control. Vice versa, a running sweep mode blocks "NRP Level Control". It can not be activated.

...
General Instrument Settings activates access over LAN to remotely control the instrument using SCPI ( S tandard C ommands for P rogrammable I nstruments) commands.
...
activates access via SSH ( S ecure Sh ell), a network protocol for secure data communication.

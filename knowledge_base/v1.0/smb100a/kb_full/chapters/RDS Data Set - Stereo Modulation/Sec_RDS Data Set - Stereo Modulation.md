...
EON (enhanced other networks, eight PS with five EON AF lists each, enables the receiver to automatically tune into these stations if a traffic programs are broadcasted)

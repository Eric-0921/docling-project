...
In addtion, you can also use a Bluetooth connection for remote control via the serial interface. The settings are effective for both interfaces (see also Chapter 4.2.3.14, "Security", on page 114 ).

...
In networks using a DHCP server, it is recommended that you address the instrument by its unambiguous computer name, see Chapter 3.1.15.2, "Using Computer Names", on page 31.

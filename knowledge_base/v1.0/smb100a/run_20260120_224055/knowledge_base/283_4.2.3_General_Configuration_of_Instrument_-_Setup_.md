---
chapter_index: 283
title: "4.2.3_General_Configuration_of_Instrument_-_Setup_"
--- 

# 4.2.3_General_Configuration_of_Instrument_-_Setup_
...
The "Setup" menu provides access to basic instrument settings, regardless of the currently set operating mode or measurement. It contains information on the insstrument's equipment, and comprises all settings for the general configuration of the instrument and its interfaces.

---
chapter_index: 1228
title: "Four_presetting_actions_are_available:"
--- 

# Four_presetting_actions_are_available:
...
Activating the preset state of the parameters related to the selected signal path ( : SOURce<hw>:PRESet on page 289)
